...
let CreateFamilyAccountComponent = class CreateFamilyAccountComponent {
    constructor() {
    }
    ngOnInit() {
    }
...
let CreateMemberComponent = class CreateMemberComponent {
    constructor() { }
    ngOnInit() {
    }
    addMember() {
...
let ConsultationComponent = class ConsultationComponent {
    constructor(api) {
        this.api = api;
    }
    ngOnInit() {
...
ConsultationComponent.ctorParameters = () => [
